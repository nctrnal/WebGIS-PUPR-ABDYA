            ...
            <div class="card my-3">
                <div class="card-body width: 100px">
                    ...
                    <form method="post" action="<?= base_url('/Irigasi/simpanUbahDaerahIrigasi/' . $daerah->id); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-floating my-3">
                            <input type="number" class="form-control" name="lebar_bawah" id="lebar_bawah" placeholder="lebar_bawah" value="<?= $daerah->lebar_bawah; ?>" required>
                            <label for="lebar_bawah" class="form-label">Lebar Bawah Daerah Irigasi</label>
                        </div>
                        <div class="form-floating my-3">
                            <input type="number" class="form-control" name="lebar_atas" id="lebar_atas" placeholder="lebar_atas" value="<?= $daerah->lebar_atas; ?>" required>
                            <label for="lebar_atas" class="form-label">Lebar Atas Daerah Irigasi</label>
                        </div>
                        <div class="form-floating my-3">
                            <input type="text" class="form-control" name="keterangan" id="keterangan" placeholder="keterangan" value="<?= $daerah->keterangan; ?>" required>
