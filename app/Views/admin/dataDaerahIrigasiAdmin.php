...
<div class="container">
    <div class="row">
        <div class="col">
            <h2 class="my-3">Berkas Daerah Irigasi</h2>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url(); ?>Berkas/update/<?= $value->id; ?>" class="btn btn-success mx-1px"><i class="bi bi-pencil-square"></i> Update</a>
                                <a href="<?= base_url(); ?>Berkas/delete/<?= $value->id; ?>" class="btn btn-danger mx-1px"><i class="bi bi-trash"></i> Delete</a>
                            </td>
                        </tr>
                    <?php
                    }
