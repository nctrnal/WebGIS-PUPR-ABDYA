                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $value->kondisi; ?> </td>
                            <td>
                                <a href="<?= base_url(); ?>/Irigasi/ubahBangunanIrigasi/<?= $value->id; ?>" class="btn btn-success"><i class="bi bi-pencil-square"></i> Detail</a>
...
<!-- Modal Upload -->
<div class="modal fade" id="tambahBangun" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
