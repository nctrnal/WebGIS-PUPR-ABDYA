            ...
            <div class="card my-3">
                <div class="card-body width: 100px">
                    ...
                    <form method="post" action="<?= base_url('/Irigasi/simpanUbahBangunanIrigasi/' . $bangunan->id); ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-floating my-3">
                            <input type="number" class="form-control" name="luas" id="luas" placeholder="luas" value="<?= $bangunan->luas; ?>" required>
                        ...
                        <div class="form my-3">
                            ...
                            <input type="file" class="form-control" name="json" id="json" placeholder="json" value="<?= $bangunan->json; ?>" required>
                        </div>
                        <div class="form my-3">
                            <label for="foto" class="form-label">Foto</label>
                            <input type="file" class="form-control" name="foto" id="foto" placeholder="foto" value="<?= $bangunan->foto; ?>" required>
                        </div>
